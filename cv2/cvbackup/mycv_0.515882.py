...
xx=[]
xx.append(np.mean(X.todense(),axis=1))
xx.append(np.mean(X1.todense(),axis=1))
xx.append(np.mean(X2.todense(),axis=1))
xx.append(np.mean(X3.todense(),axis=1))
xx.append(np.mean(X4.todense(),axis=1))
xx=np.hstack(xx)

X=sparse.hstack([X,X1,X2,X3,X4,X6,X7,X8,X9,X10,xx],format='csr').todense()
