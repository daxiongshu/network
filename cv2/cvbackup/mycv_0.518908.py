...
def kfold_cv(X_train, y_train,k):
    ...
    for train_index, test_index in kf:
        ...
        clf=xgb_classifier(eta=0.1,col=0.1,min_child_weight=1,depth=6,num_round=200)
...
X=sparse.hstack([X,X1,X2,X3,X4,xx,pickle.load(open('../explore/X3.p'))],format='csr').todense()
